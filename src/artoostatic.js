...
(function(e) {
                    ...
                    fn: function() {
                        ...
                        e.addEventListener("load", function() {
                            var t = e.getResponseHeader("Content-Type"),
                                n = e.response;
                            if (t && ~t.search(/json/)) try {
                                    n = JSON.parse(e.responseText)
                                } catch (r) {} else if (t && ~t.search(/xml/)) n = e.responseXML;
                                else try {
                                    n = JSON.parse(e.responseText)
                                } catch (r) {
                                    n = e.responseText
    ...
    function(e) {
        ...
        function t(e, o, n, r, i) {
            ...
            function s(i) {
                var a = i;
                if ((o.scrape || o.scrapeOne || o.jquerify) && (i = artoo.helpers.jquerify(i)), o.scrape || o.scrapeOne) {
                    var s = o.scrape ? "scrape" : "scrapeOne";
                    a = artoo[s](i.find(o[s].iterator), o[s].data, o[s].params)
                } else "function" == typeof o.process && (a = o.process(i, n, r));
                return a === !1 ? o.done(r) : (o.concat ? r = r.concat(a) : r.push(a), n++, void(artoo.helpers.isArray(e) && n === e.length || n === o.limit ? o.done(r) : t(e, o, n, r, i)))
            }
            r = r || [], n = n || 0;
    ...
    function(e) {
        ...
        function t(t, o) {
            ...
            return n = "function" == typeof t ? t.call(o, r, i.get()) : "function" == typeof t.method ? t.method.call(i.get(), r, i.get()) : "string" == typeof t ? "function" == typeof i[t] ? i[t]() : i.attr(t) : t.attr !== e ? i.attr(t.attr) : i[t.method || "text"](), t.defaultValue && !n && (n = t.defaultValue), n
        }
        ...
        artoo.scrape = function(e, t, r, i) {
            ...
            if (o.headers) {
                var s = o.headers.type || o.headers.method && "first" || o.headers,
                    c = o.headers.method;
                if ("th" === s) i = artoo.scrape(r(a).find("th"), c || "text");
                else if ("first" === s) i = artoo.scrape(r(a).find(" tr:has(td):first-of-type td"), c || "text");
                else {
                    if (!artoo.helpers.isArray(s)) throw TypeError("artoo.scrapeTable: wrong headers type.");
                    i = s
                }
                return artoo.scrape(r(a).find("tr:has(td)" + ("first" === s ? ":not(:first-of-type)" : "")), function() {
                    var e = {};
                    return i.forEach(function(n, i) {
                        e[n] = t(o.data || "text", r(this).find("td:nth-of-type(" + (i + 1) + ")"))
                    }, this), e
                }, o, n)
            }
            return artoo.scrape(r(a).find("tr:has(td)"), {
                scrape: {
                    iterator: "td",
                    data: o.data || "text"
                }
    ...
    function(e) {
        ...
        artoo.ui = function(e) {
            ...
            this.name = e.name || r, o[this.name] = this, this.mountNode = e.mountNode || artoo.mountNode, this.host = document.createElement("div"), this.host.setAttribute("id", r), this.mountNode.appendChild(this.host), this.shadow = this.host.attachShadow({
                mode: "open"
            }), this.$ = function(e) {
